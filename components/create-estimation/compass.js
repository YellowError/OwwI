...
<<<<<<< HEAD
    return (
        <div className="boussoleWidth">
            <div className="boussole">
            <div className="pointsCardinaux ">
                <p className="nord pointsCardinaux pointCardinal">N</p>
            </div>
            <div className="pointsCardinaux">
                <p className="nordOuest pointsCardinaux pointCardinal">NO</p>
                <p className="nordEst pointsCardinaux pointCardinal">NE</p>
            </div>
            <div className="pointsCardinaux">
                <p className="ouest pointsCardinaux pointCardinal">O</p>
                <p className="est pointsCardinaux pointCardinal">E</p>
            </div>
            <div className="pointsCardinaux">
                <p className="sudOuest pointsCardinaux pointCardinal">SO</p>
                <p className="sudEst pointsCardinaux pointCardinal">SE</p>
            </div>
            <div className="pointsCardinaux">
                <p className="sud pointsCardinaux pointCardinal">S</p>
            </div>
            <svg className="cadranBoussole" width="4.5rem" viewBox="0 0 112 112" version="1.1">
            ...
            <svg className="flecheBoussole" width="1.5rem" viewBox="0 0 43 43" version="1.1">
                <g transform="matrix(1,0,0,1,-2038.32,-788.09)">
                    <g transform="matrix(2.66667,0,0,2.66667,1785.83,0)">style
