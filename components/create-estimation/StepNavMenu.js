...
const StepNavMenu = () => {
  ...
  return (
    <div>
      <ul className="flex items-center stepEstimation">
        <li
      ...
      <div className="btn-container">
        <button className="btn bg-gray-500" id="Back" onClick={btnBack}>
          Back
        </button>
        <button className="btn bg-green-500" id="Next" onClick={btnNext}>
          Next
        </button>
      </div>
    </div>
