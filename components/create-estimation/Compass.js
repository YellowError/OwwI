...
const Compass = () => {
  ...
  const pointsCardinal = [ "north", "northWest", "northEast", "west", "east", "southWest", "southEast", "south"]
        ...
        <div className="flex hidden">
          {pointsCardinal.map((pointCardinal, index)=>(
            <div className="m-2" key={pointCardinal}>
                ...
                <input className="mx-2" type="radio" name="compassValue" id={pointCardinal} value={pointCardinal} defaultChecked={`${cardinalPointActive == pointCardinal ? isChecked : ""}`}/>
            </div>
          ))}
        </div>
        ...
        <div className="compassWidth">
            ...
            {pointsCardinal.map((pointCardinal, index)=> (
             <div className="pointsCardinal" key={pointCardinal}>
                <p className={`${cardinalPointActive == pointCardinal ? "cardinalPointActive" : ""} ${pointCardinal} pointsCardinal cardinalPoint`} id={pointCardinal} onClick={()=>{compassValueSelected(pointCardinal)}}>{pointsCardinalAbr[index]}</p>
            </div>
            ))}
            <svg className="dialCompass" width="4.5rem" viewBox="0 0 112 112" version="1.1">
            ...
            <svg className="arrowCompass" width="1.5rem" viewBox="0 0 43 43" version="1.1">
